...
public class RenderHurricaneSkull
  extends Render
{
  ...
  public RenderHurricaneSkull(RenderManager p_i46129_1_)
  {
    super(p_i46129_1_);
  }
   ...
   */
  public void doRender(EntityHurricaneSkull entity, double x, double y, double z, float p_76986_8_, float partialTicks)
  {
  ...
  protected ResourceLocation func_180564_a(EntityHurricaneSkull p_180564_1_)
  {
  ...
  {
      return this.func_180564_a((EntityHurricaneSkull)entity);
  }
  ...
  {
      this.doRender((EntityHurricaneSkull)entity, x, y, z, p_76986_8_, partialTicks);
  }
}
