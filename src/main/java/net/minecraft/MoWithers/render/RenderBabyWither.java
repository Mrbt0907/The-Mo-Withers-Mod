...
import net.minecraft.MoWithers.render.shields.LayerBabyWitherAura;
  ...
  extends RenderLiving
{
  ...
  {
    super(p_i46130_1_, new ModelBabyWither(0.0F), 0.5F);
    addLayer(new LayerBabyWitherAura(this));
  }
  ...
  {
    func_180591_a((EntityBabyWither)entity, x, y, z, p_76986_8_, partialTicks);
  }
  
  protected void preRenderCallback(EntityLivingBase p_77041_1_, float p_77041_2_)
  {
    func_180592_a((EntityBabyWither)p_77041_1_, p_77041_2_);
  }
  ...
  {
    return getEntityTexture((EntityBabyWither)entity);
  }
