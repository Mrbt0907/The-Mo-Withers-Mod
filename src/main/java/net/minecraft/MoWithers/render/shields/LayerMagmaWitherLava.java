...
public class LayerMagmaWitherLava
  implements LayerRenderer
{
  ...
  private final ModelMagmaWither field_177216_c = new ModelMagmaWither(0.0F);
  
  public LayerMagmaWitherLava(RenderMagmaWither p_i46105_1_)
  {
