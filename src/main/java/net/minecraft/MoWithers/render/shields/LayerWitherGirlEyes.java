...
public class LayerWitherGirlEyes implements LayerRenderer
{
    private static final ResourceLocation witherGirlEyesInLove = new ResourceLocation("mowithers", "textures/entities/wither_girl_overlay_4.png");
    private static final ResourceLocation witherGirlEyesBlushing = new ResourceLocation("mowithers", "textures/entities/wither_girl_overlay_3.png");
    ...
    private final RenderWitherGirl field_177202_b;

    public LayerWitherGirlEyes(RenderWitherGirl p_i46117_1_)
    {
        this.field_177202_b = p_i46117_1_;
    }

    public void func_177201_a(EntityWitherGirl p_177201_1_, float p_177201_2_, float p_177201_3_, float p_177201_4_, float p_177201_5_, float p_177201_6_, float p_177201_7_, float p_177201_8_)
    {
    	if (p_177201_1_.isBlinking())
    		this.field_177202_b.bindTexture(witherGirlEyesBlinking);
    	else
    	{
    		if (p_177201_1_.hasBeenRecentlySlapped)
    			this.field_177202_b.bindTexture(witherGirlEyesBlushing);
    		else if (p_177201_1_.isInLove())
    			this.field_177202_b.bindTexture(witherGirlEyesInLove);
    		else
    ...
    {
        this.func_177201_a((EntityWitherGirl)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
    }
}