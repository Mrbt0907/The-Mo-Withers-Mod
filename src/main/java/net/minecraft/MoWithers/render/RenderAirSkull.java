  ...
  extends Render
{
  ...
  public RenderAirSkull(RenderManager p_i46129_1_)
  {
    super(p_i46129_1_);
  }
   ...
   */
  public void doRender(EntityAirSkull entity, double x, double y, double z, float p_76986_8_, float partialTicks)
  {
  ...
  protected ResourceLocation func_180564_a(EntityAirSkull p_180564_1_)
  {
  ...
  {
      return this.func_180564_a((EntityAirSkull)entity);
  }
  ...
  {
      this.doRender((EntityAirSkull)entity, x, y, z, p_76986_8_, partialTicks);
  }
}
