...
public class ModelWitherGolem extends ModelBase
{
    ...
    public ModelWitherGolem()
    {
        this(0.0F);
    }

    public ModelWitherGolem(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public ModelWitherGolem(float p_i46362_1_, float p_i46362_2_)
    {
        short short1 = 128;
        short short2 = 128;
        ...
        this.ironGolemLeftArm.setTextureOffset(60, 21).addBox(9.0F, -2.5F, -3.0F, 4, 30, 6, p_i46362_1_);
    ...
    {
    	EntityWitherGolem entityirongolem = (EntityWitherGolem)p_78086_1_;
        int i = entityirongolem.getAttackTimer();

        if (i > 0)
        {
            this.ironGolemRightArm.rotateAngleX = -3.0F + 1.5F * this.func_78172_a((float)i - p_78086_4_, 10.0F);
            this.ironGolemLeftArm.rotateAngleX = -3.0F + 1.5F * this.func_78172_a((float)i - p_78086_4_, 10.0F);
        }
        else
        {
